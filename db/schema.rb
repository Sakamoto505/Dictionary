...
ActiveRecord::Schema[7.0].define(version: 20_231_128_115_800) do
  ...
  create_table 'words', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.virtual 'tsv_word', type: :tsvector,
                          as: "to_tsvector('simple'::regconfig, (COALESCE(ingush_word, ''::character varying))::text)", stored: true
    t.virtual 'tsv_translation', type: :tsvector,
                                 as: "to_tsvector('simple'::regconfig, (COALESCE(russian_word, ''::character varying))::text)", stored: true
    t.virtual 'tsv_ingush_word', type: :tsvector,
                                 as: "to_tsvector('simple'::regconfig, (COALESCE(ingush_word, ''::character varying))::text)", stored: true
    t.virtual 'tsv_russian_word', type: :tsvector,
                                  as: "to_tsvector('simple'::regconfig, (COALESCE(russian_word, ''::character varying))::text)", stored: true
